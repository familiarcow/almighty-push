...
6. After success, display the Rinnegan eyes art by running the rinnegan script via Bash: `${CLAUDE_PLUGIN_ROOT}/scripts/rinnegan.sh` — this auto-detects terminal width and adjusts the spacing between the eyes. Display its output as a code block in your response.
